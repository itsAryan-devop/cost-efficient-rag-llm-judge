...
NO_CONTEXT_MESSAGE = (
    "I could not find relevant context in the indexed documents to answer this question."
)
...
def build() -> None:
    ...
    if missing:
        raise SystemExit(
            "Chunk references not found in inventory (re-run export_chunks?): " + str(missing)
        )
    ...
    print(f"Wrote {len(dataset)} questions ({answerable} answerable, "
